...
export function Hero({ developments }: { developments: Development[] }) {
 ...
 <h1 className={'max-w-xl text-4xl font-semibold leading-tight text-slate-950 sm:text-5xl'}>Encontrá tu próximo lote con información clara y consulta inmediata.</h1>
 <p className={'mt-5 max-w-xl text-lg leading-8 text-slate-600'}>{siteConfig.brand.name} presenta loteos con financiación, disponibilidad actualizada y una experiencia pensada para que cada cliente entienda rápido qué sigue activo y cómo avanzar.</p>
 ...
 <a data-testid={'home-cta-whatsapp'} href={'https://wa.me/' + siteConfig.contact.whatsappNumber + '?text=' + encodeURIComponent(siteConfig.contact.homeWhatsAppIntro)} target={'_blank'} rel={'noopener noreferrer'} className={'inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-6 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-300 hover:text-slate-950'}>Consultar por WhatsApp</a>
 </div>
 </div>
