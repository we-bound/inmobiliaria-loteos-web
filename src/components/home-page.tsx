...
export function HomePage() {
 ...
 <p className={'mt-2 max-w-2xl text-sm leading-7 text-slate-600'}>Una selección pensada para combinar alquileres y ventas con fichas rápidas, precio flexible y contacto comercial inmediato.</p>
 </div>
 ...
 <p className={'text-xs font-semibold uppercase tracking-[0.2em] text-slate-400'}>Cómo trabajamos</p>
 <h3 className={'mt-3 text-2xl font-semibold text-slate-950'}>Un flujo simple para presentar mejor cada oportunidad.</h3>
 ...
 <p className={'text-xs font-semibold uppercase tracking-[0.2em] text-sky-700'}>Valor comercial</p>
 <h3 className={'mt-3 text-2xl font-semibold text-slate-950'}>{siteConfig.brand.name} integra loteos y propiedades en una sola experiencia.</h3>
 <p className={'mt-4 max-w-xl text-sm leading-7 text-slate-600'}>La propuesta combina una landing sobria, filtros útiles, plano interactivo, catálogo de propiedades y un panel comercial consistente para vender mejor y responder más rápido.</p>
